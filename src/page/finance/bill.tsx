        ...
        },
        {
            ...
            render(value){
                return <>
                    ...
                    <Button type="primary" size="small" danger className="ml mr">Cancel Bill</Button>
    ...
    return <div>
        ...
        <Card className="mt search">
            <Row gutter={16}>
                ...
                <Col span={6}>
                    <p>Room/Car Number：</p>
                    <Input placeholder="Please enter the room number or parking number" value={formData.no} onChange={handleChange1}/>
                </Col>
                <Col span={6}>
                    <p>Payment Status</p>
                    <Select                 
        ...
        <Card className="mt">
            ...
            <Button icon={<DeleteOutlined/>} danger className="ml" type="primary"  disabled={disabled}>Batch Cancel</Button>
        </Card>
        <Card className="mt">
            <Table
                dataSource={dataList}
